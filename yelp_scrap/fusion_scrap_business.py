...
def query_api(api_key, location, output_file):  # , term
    ...
    """
    response = search(api_key, location)  # , term
    ...
    for business in businesses:
        ...
        print(Saerching for location, len(businesses))
        '''
...
def main():
    ...
    try:
        query_api(input_values.api_key,
                  input_values.location, input_values.output)  # , input_values.term
